-- DNL P&L — Add amount to customer delivery site presets (existing projects)
-- Run in Supabase SQL Editor if you already ran customer-delivery-sites.sql without amount.

alter table public.customer_delivery_sites
...
update public.customer_delivery_sites
set amount = 0
